...
// export const getVideoData = async function (
//   container,
//   index,
//   pageToken = "",
//   vidCounter
...
//     );
//     if (vidCounter != 9) {
//       if ((index = 4 && data.nextPageToken)) {
//         await getVideoData(container, 0, data.nextPageToken, vidCounter + 1);
//       } else {
//         await getVideoData(container, index + 1, page_token, vidCounter + 1);
//       }
//     }
//   } catch (error) {
//     console.error(error);
...
getVideoData(postsContainer, 0, "", 0);
...
var getSubscriptionData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(index) {
    var _subContainer, _subContainer2, res, data, subData, subBtn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (_subContainer = subContainer) === null || _subContainer === void 0 || _subContainer.insertAdjacentHTML("afterbegin", renderSubscriptions(subData, index));
          subBtn = (_subContainer2 = subContainer) === null || _subContainer2 === void 0 ? void 0 : _subContainer2.querySelector(".sub-btn");
  ...
  return function getSubscriptionData(_x) {
...
var getStoryData = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(index) {
    var _storyContainer, res, data, storyData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          return getChannelData(data.items[index].snippet.channelId);
        case 9:
          storyData = _context2.sent;
          (_storyContainer = storyContainer) === null || _storyContainer === void 0 || _storyContainer.insertAdjacentHTML("beforeend", renderStories(storyData, data, index));
          _context2.next = 16;
          break;
        case 13:
          _context2.prev = 13;
  ...
  return function getStoryData(_x2) {
...
(_seeProfileLink = seeProfileLink) === null || _seeProfileLink === void 0 || _seeProfileLink.addEventListener("click", goToProfile);
