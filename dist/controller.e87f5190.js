...
var YoutubeModel = exports.YoutubeModel = {
  ...
  getVideoPageData: function getVideoPageData() {
    var _arguments = arguments;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var pageToken, response, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            pageToken = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : "";
            _context2.prev = 1;
            _context2.next = 4;
  ...
  allVideosData: [],
  getAllVideosData: function getAllVideosData() {
    var _arguments2 = arguments,
      _this = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var pageToken, pageNum, maxPages, currData;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            pageToken = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : "";
            pageNum = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : 1;
            maxPages = _this.pagination.totalResults / _this.pagination.resultsPerPage;
            if (!(pageNum <= maxPages)) {
              _context3.next = 14;
              break;
            }
            _context3.next = 6;
            return _this.getVideoPageData(pageToken);
          case 6:
            currData = _context3.sent;
            if (currData) {
              _context3.next = 9;
              break;
            }
          ...
          case 9:
            _this.allVideosData = _this.allVideosData.concat(currData.items);
            if (!currData.nextPageToken) {
              _context3.next = 14;
              break;
            }
            _context3.next = 13;
            return _this.getAllVideosData(currData.nextPageToken, pageNum + 1);
          case 13:
            return _context3.abrupt("return", _context3.sent);
          case 14:
            return _context3.abrupt("return", _this.allVideosData);
          case 15:
          case "end":
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            start = (_this2.pagination.currentPage - 1) * _this2.pagination.resultsPerPage;
            end = start + _this2.pagination.resultsPerPage;
            _context4.next = 4;
            return _this2.getAllVideosData("", 1);
          case 4:
            data = _context4.sent;
            return _context4.abrupt("return", data.slice(start, end));
          case 6:
          case "end":
        ...
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            return _context5.abrupt("return", data.items.map(function (item) {
              return _this3.getChannelData(item.snippet.channelId);
            }));
          case 11:
  ...
  getStoryData: function getStoryData() {
    var _this4 = this;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            return _context6.abrupt("return", data.items.map(function (item) {
...
var YoutubeView = exports.YoutubeView = {
  ...
  _generateMarkup: function _generateMarkup() {
    var currPage = _model.YoutubeModel.pagination.currentPage;
    var numPages = Math.ceil(_model.YoutubeModel.pagination.totalResults / _model.YoutubeModel.pagination.resultsPerPage);
    ...
    var markupFwrdBtn = "<button data-goto=\"".concat(currPage + 1, "\" class=\"btn--inline pagination__btn--next\">\n                  <span>Page ").concat(currPage + 1, "</span>\n                  <svg class=\"search__icon\">\n                    <use href=\"").concat(_icons.default, "#icon-arrow-right\"></use>\n                  </svg>\n                </button>\n          ");
...
var YoutubeController = exports.YoutubeController = {
  ...
  initPagination: function initPagination() {
    ...
    _view.YoutubeView.renderPagination();
  },
  setupPaginationClickHandler: function setupPaginationClickHandler() {
    var _this2 = this;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _model.YoutubeModel.getPageData();
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _iterator = _createForOfIteratorHelper(pageData);
            _context3.prev = 3;
            _iterator.s();
          case 5:
